...
INSERT INTO `bootcamp`.`tipounidade` (`idTipoUnidade`, `dscTipoUnidade`) VALUES (7, 'Loft');
INSERT INTO `bootcamp`.`tipounidade` (`idTipoUnidade`, `dscTipoUnidade`) VALUES (8, 'Chácara');
